# This routine is disgned to run from the terminal or cluster
...
Visualisation2(order,Nv,time_method,kstages,integration_type,icase,Tfinal,alpha,beta,x_boundary,y_boundary, solver_type)